 ...
 */
class AttendanceAdapter : ListAdapter<AttendanceRecord, AttendanceAdapter.ViewHolder>(AttendanceDiffCallback()) {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val txtTime: TextView = view.findViewById(R.id.txtStatValue)
        val txtDate: TextView = view.findViewById(R.id.txtStatValueSecondary)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.txtTime.text = timeFormat.format(java.time.Instant.ofEpochMilli(record.timestamp).atZone(java.time.ZoneId.systemDefault()))
        ...
        holder.viewAccent.setBackgroundColor(android.graphics.Color.TRANSPARENT)
    }
